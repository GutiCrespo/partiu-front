...
export default function CardPlace({ placeName, placePhoto, placeRating, placeLocation }: CardPlaceProps) {

    const displayPhoto = placePhoto && placePhoto.startsWith("places/")
        ? `/api/places/photo?photoName=${(placePhoto)}`
        : placePhoto;
        ...
        <div className="bg-white w-fit flex flex-col justify-center p-4 gap-2 rounded-lg">
            <div className="relative w-[200px] h-[120px]">
                <Image
                    ...
                    alt="Foto Local"
                    src={displayPhoto || "/mockup/place.png"}
            ...
            <div className="flex justify-between">
                <p className="font-bold">{placeName || "Jardim Botânico Jardim"}</p> 
                <div className="Rating flex items-center">
                    ...
                    <p className="text-normal-gray">{placeRating || "4,7"}</p>
                </div>
            </div>
            <div className="Location flex">
                ...
                <p className="small text-normal-gray">{placeLocation || "Curitiba, centro"}</p>
            </div>
        </div>
    )
}